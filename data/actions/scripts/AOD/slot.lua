...
-- [{FRUIT.1,FRUIT.2,FRUIT.3} = {PRIZE,#PRIZE}]
	--MIXED COMBOS
	[{2679,2683,2679}] = {9020,4}, -- cherry-pumpkin-cherry
	[{8841,2682,8841}] = {9020,3}, -- lemon-melon-lemon
	--TRIPLE COMBOS
	[{2680,2680,2680}] = {9020,20}, -- triple strawberry
	[{5097,5097,5097}] = {9020,10}, -- triple mango
	[{2683,2683,2683}] = {9020,20}, -- triple pumpkin
	[{2682,2682,2682}] = {9020,10}, -- triple melon
	[{2676,2676,2676}] = {9020,8}, -- triple banana
	[{8841,8841,8841}] = {9020,9}, -- triple lemon
	[{2679,2679,2679}] = {9020,11}, -- triple cherry
	[{2675,2675,2675}] = {9020,13}, -- triple orange
	[{2674,2674,2674}] = {9020,5}, -- triple apple
	--ANY COMBOS
	[{ANY,2683,2683}] = {9020,1}, -- double pumpkin right
	[{2683,2683,ANY}] = {9020,1}, -- double pumpkin left
	[{2683,ANY,2683}] = {9020,1}, -- pumpkin sides combo
	[{ANY,2679,2679}] = {2160,50}, -- double cherry right
	[{2679,2679,ANY}] = {2160,50}, -- double cherry left
	[{2679,ANY,2679}] = {9020,1}, -- cherry sides combo
	[{ANY,8841,8841}] = {9020,1}, -- double lemon right
	[{8841,8841,ANY}] = {2160,50}, -- double lemon left
	[{8841,ANY,8841}] = {2160,50}, -- lemon sides combo
}
